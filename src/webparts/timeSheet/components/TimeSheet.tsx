...
import { DefaultButton, Dialog, Dropdown, Icon, IIconProps, PrimaryButton, TextField } from 'office-ui-fabric-react';
...
const DeleteFilterDialogContentProps = {
  title: "Alert",
  alert: "Are You Sure Delete this Details"
}
          ...
          <div className='ms-Grid'>
            <div className='ms-Grid-row'>
                      ...
                      <div className='ms-Grid-col ms-sm6 ms-md3 ms-lg3'>
                        <div className='Card'>
                          ...
                          <div className='card-Choice'>
                            <p><Icon iconName='Devices3' className='icon'></Icon>{item.Status}</p>
                            <p><Icon iconName='Devices3' className='icon'></Icon>{item.Technology}</p>
                          </div>
              ...
              <Dialog 
                   ...
                   minWidth={500}
              >
                <div className='ms-Grid-col Delete-TimeSheet'>
