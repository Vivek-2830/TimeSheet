...
import { DatePicker, DefaultButton, Dropdown, PrimaryButton, TextField, IIconProps, Icon } from 'office-ui-fabric-react';
                      ...
                      <div className='ms-Grid-row Add-Form'>
                        <div className="ms-Grid-col ms-sm12 ms-md12 ms-lg12 mt-25 text-center">
                            <div className='ms-Grid-col Submit-button'>
                              <PrimaryButton text="Submit" onClick={() => this.AddTimesheet()} />
                            </div>
